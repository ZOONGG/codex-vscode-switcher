...
- Confirm branch is `codex/fix-workspace-and-codex-sidebar-ux`.
...
- Run `.\smoke-test-workspace-restore.ps1` and require project restore, simulated profile switch, `chatgpt.openSidebar`, and ordinary-VS-Code isolation to pass.
